...
#   security_groups            = [module.loadbalancer_sg.security_group_id] #bhula
#   enable_deletion_protection = false
#   #Listeners 

#   listeners = {
#     # Listener 1 HTTP TO HTTPS REDIRECT    #MAJOR CHANGES COMPARED TO PREVIOUS MODULE 
...
#               }
#             }]
#           } # End Of Listeners Rules For app1
#           myapp2-rule = {
#             actions = [{
#               type = "weighted-forward"
#               target_groups = [
...
#               }
#             }]
#           } # End Of Listeners Rules For app2
...
#           name_prefix                       = "mytg1-"
#           protocol                          = "HTTP" #1 backend_ protocol 
#           port                              = 80     #2 backend_ port
...
#   #for_each         = { for ec2instances, instances_details in module.ec2_private_app1 : ec2instances => instances_details } #
...
#             }
#           }]
#         } # End Of Listener Rules For app1
...
#             }
#           }]
#         } # End Of Listener Rules For app2
#       }
#     }
#   }
